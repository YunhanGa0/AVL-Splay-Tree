...
public class AVLTreeStructureTest {
   ...
   public static void main( String[] args ) {
      ...
      System.out.println( "Is the AVL Tree in the expected shape(put)? " + ( areEqual( t1, t1.root(), t2, t2.root() ) ? "YES! :-D" : "No! :-(" ) );
      ...
      System.out.println( "Is the AVL Tree in the expected shape(remove)? " + ( areEqual( t1, t1.root(), t3, t3.root() ) ? "YES! :-D" : "No! :-(" ) );
   }
